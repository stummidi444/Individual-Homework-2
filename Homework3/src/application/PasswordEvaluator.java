...
public class PasswordEvaluator {
	...
	public static String evaluatePassword(String input) {
		...
		while (running) {
			...
			} else if ("~`!@#$%^&*()_-+{}[]|:,.?/".indexOf(currentChar) >= 0) { //I REMOVED SOME SPECIAL CHARACTERS HERE THAT ARE NOT INCLUDED IN HW DESCRIPTION
		...
		String errMessage = "";
		if (!foundUpperCase)
			errMessage += "Password Error: It must have atleast one upper case\n ";// I CHANGED THE ERROR MESSAGE TO BE MORE CLEAR ABOUT THE ERROR
		
		if (!foundLowerCase)
			errMessage += "Password Error: It must have atleast one lower case\n "; // I CHANGED THE ERROR MESSAGE TO BE MORE CLEAR ABOUT THE ERROR
		
		if (!foundNumericDigit)
			errMessage += "Password Error: It must have atleast one numeric digit\n "; // I CHANGED THE ERROR MESSAGE TO BE MORE CLEAR ABOUT THE ERROR
			
		if (!foundSpecialChar)
			errMessage += "Password Error: It must have atleast one special character\n "; // I CHANGED THE ERROR MESSAGE TO BE MORE CLEAR ABOUT THE ERROR
			
		if (!foundLongEnough)
			errMessage += "Password Error: The password must be atleast 8 characters\n "; // I CHANGED THE ERROR MESSAGE TO BE MORE CLEAR ABOUT THE ERROR
		
		if (errMessage == "")
			return "";
		
		passwordIndexofError = currentCharNdx;
		return errMessage; //REMOVED THE ERROR MESSAGE HERE AND ADDED IT ABOVE SO IT MAKES THE ERROR MORE CLEAR
