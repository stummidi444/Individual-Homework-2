...
public class UserNameRecognizer {
	...
	public static boolean startsWithLetter = false;
	public static boolean foundSpecialChar = false;				//Special character (!@#$%^&*)
	
	public static boolean notEmpty =  false;					//Input is at least one char
	public static boolean usernameTooLong = false;				//Username exceeds 16 characters
	public static boolean consecutivePeriod = false;			//Username contains ".." which is not allowed
	...
	public static String checkForValidUserName(String input) {
		...
		if(input.length() <= 0) {
			...
			return "\n*** USERNAME ERROR *** The input is empty"; //I ADDED USERNAME IN HERE SO THAT IT IS MORE CLARIFIED
				...
				while (running) {
					...
					case 0: 
						...
						if ((currentChar >= 'A' && currentChar <= 'Z' ) ||		// Check for A-Z
								...
								) { //I REMOVED 0-9 AS THE FIRST CHARACTER SHOULD NOT BE A NUMERICAL
							nextState = 1;
					...
					case 1: 
						...
						(currentChar == '_')||
						(currentChar == '-'))// I ADDED _,- SPECIAL CHARACTERS AS REQUIRED PER CONDITIONS
						{							// Check for /
							nextState = 2;
						...
						if (userNameSize > 16)
							running = false;
							usernameTooLong = true; //trips flag for the integrated test
						break;			
